...
#[ic_cdk::query]
pub async fn icp_tx() -> Vec<WalletTX> {
...
#[ic_cdk::query]
pub async fn ckBTC_balance() -> Nat {
    let balance = ic_cdk::call::<(Account, ), (Nat, )>(
...
#[ic_cdk::query]
pub async fn ckBTC_tx() -> Vec<WalletTX> {
    let txs_result: GetAccountIdentifierTransactionsResult = ic_cdk::call::<(GetAccountTransactionsArgs, ), (GetAccountIdentifierTransactionsResult, )>(
...
#[ic_cdk::query]
pub async fn ghost_balance() -> Nat {
    let balance = ic_cdk::call::<(Account, ), (Nat, )>(
...
#[ic_cdk::query]
pub async fn ghost_tx() -> Vec<WalletTX> {
    let txs_result: GetAccountIdentifierTransactionsResult = ic_cdk::call::<(GetAccountTransactionsArgs, ), (GetAccountIdentifierTransactionsResult, )>(
...
#[ic_cdk::query]
pub async fn token_balance(token: Principal) -> Nat {
    let balance = ic_cdk::call::<(Account, ), (Nat, )>(
        token, 
        "icrc1_balance_of", 
        (Account {
