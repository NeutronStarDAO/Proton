...
fn test_cancle_black_list() {
    ...
    let cancle_black_list_result = pocket_ic::update_candid_as::<(Principal, ), (bool, )>(
        &pic, 
        user_canister, 
        user_a, 
        "cancle_black_list", 
    ...
    assert!(cancle_black_list_result);
